...
| <a href="#space-crawl"><img src="docs/themes/space-crawl.webp" width="150" alt="Space Crawl"></a> | **[Space Crawl](#space-crawl)**<br><sub>CINEMATIC & CLASSIC</sub> | The space-opera homage — golden text receding up a tilted plane into a deep starfield toward a glowing galactic core. |
...
| <a href="#broadway-playbill"><img src="docs/themes/playbill.webp" width="150" alt="Broadway Playbill"></a> | **[Broadway Playbill](#broadway-playbill)**<br><sub>CINEMATIC & CLASSIC</sub> | An engraved theatre programme on aged, gold-stamped cream stock — the one light theme. |
| <a href="#quest-log"><img src="docs/themes/quest-log.webp" width="150" alt="Quest Log"></a> | **[Quest Log](#quest-log)**<br><sub>CINEMATIC & CLASSIC</sub> | A candlelit tavern ledger on night-stained parchment — blackletter quest headings, ruled sign-in rows with "× N" tallies, a wax-seal outro. |
| <a href="#neon-night-drive"><img src="docs/themes/synthwave.webp" width="150" alt="Neon Night Drive"></a> | **[Neon Night Drive](#neon-night-drive)**<br><sub>RETRO, SYNTH & TERMINAL</sub> | OutRun at 2AM: chrome VHS-logo titles over a magenta grid driving toward a striped sunset, a high-score-style roster, neon-tube outro. |
...
| <a href="#arcade-high-score"><img src="docs/themes/arcade.webp" width="150" alt="Arcade High Score"></a> | **[Arcade High Score](#arcade-high-score)**<br><sub>RETRO, SYNTH & TERMINAL</sub> | A CRT cabinet in attract mode: Press Start 2P pixel font, ranked HIGH SCORES panels with dot leaders and `PTS`, per-section hue cycling, a blinking `GAME OVER` outro. |
...
| <a href="#junglist"><img src="docs/themes/dnb.webp" width="150" alt="Junglist"></a> | **[Junglist](#junglist)**<br><sub>MUSIC & DJ</sub> | Acid-green pirate-radio signal: oscilloscope waveform dividers under stencil titles, a `174 BPM / SIGNAL LOCKED` HUD, a breathing spectrum analyzer, `>> ON AIR` chip. |
| <a href="#block-party"><img src="docs/themes/boombox.webp" width="150" alt="Block Party"></a> | **[Block Party](#block-party)**<br><sub>MUSIC & DJ</sub> | A 90s stoop jam: a detailed boombox, spray-paint graffiti titles on torn-paper labels, brick wall with string lights, cassette-tape dividers, `SOUND CLASH` finale. |
| <a href="#mainstage"><img src="docs/themes/mainstage.webp" width="150" alt="Mainstage"></a> | **[Mainstage](#mainstage)**<br><sub>MUSIC & DJ</sub> | The credits as a festival poster: an LED-wall stage, volumetric laser fans, a phone-lit crowd silhouette, confetti, stage-name sections, a headliner finale. |
| <a href="#sunrise-set"><img src="docs/themes/melodic.webp" width="150" alt="Sunrise Set"></a> | **[Sunrise Set](#sunrise-set)**<br><sub>MUSIC & DJ</sub> | A 6am hillside set — a soft rising sun with god-rays over a dawn-warmed sky, a crowd with raised hands watching, drifting lantern orbs, airy lowercase type. |
...
| <a href="#final-round"><img src="docs/themes/fighter.webp" width="150" alt="Final Round"></a> | **[Final Round](#final-round)**<br><sub>GAMING</sub> | Arcade fighting-game energy: two rim-lit fighter silhouettes, ink brush-slash accents, roster rows with health bars, `ROUND N / FIGHT!` sections and a `K.O.!!` finale. |
| <a href="#victory-fanfare"><img src="docs/themes/rpg.webp" width="150" alt="Victory Fanfare"></a> | **[Victory Fanfare](#victory-fanfare)**<br><sub>GAMING</sub> | A classic 16-bit JRPG menu: beveled blue window-skin panels with double borders, a hand cursor on rows, `EXP +500` amounts, quest-complete banners, a `LEVEL UP!` finale. |
...
| <a href="#grand-finals"><img src="docs/themes/esports.webp" width="150" alt="Grand Finals"></a> | **[Grand Finals](#grand-finals)**<br><sub>GAMING</sub> | An esports broadcast overlay: glossy angular lower-thirds, a floodlit arena crowd, hex accents, a scoreline, team-tag rows and an `MVP` finale. |
| <a href="#chequered-flag"><img src="docs/themes/grandprix.webp" width="150" alt="Chequered Flag"></a> | **[Chequered Flag](#chequered-flag)**<br><sub>GAMING</sub> | A night-race world feed: a timing tower (position, name, gap), a floodlit grandstand crowd, an F1 car streaking the pit straight, a chequered-flag band, `CHEQUERED FLAG — P1` finale. |
...
| <a href="#netrunner"><img src="docs/themes/netrunner.webp" width="150" alt="Netrunner"></a> | **[Netrunner](#netrunner)**<br><sub>CYBER & CTF</sub> | A holographic AR HUD over a neon city: glassmorphic panels, angular corner brackets, teal/magenta duotone, monospace stat chips, an `INTRUSION DETECTED` finale. |
...
| <a href="#neo-noir"><img src="docs/themes/neo-noir.webp" width="150" alt="Neo-Noir"></a> | **[Neo-Noir](#neo-noir)**<br><sub>NIGHT, SCENE & NOSTALGIA</sub> | Rain-slick monochrome with venetian-blind light and film grain, typewriter case-file rows — and exactly one red word, saved for the raid finale. |
| <a href="#silver-nocturne"><img src="docs/themes/luna.webp" width="150" alt="Silver Nocturne"></a> | **[Silver Nocturne](#silver-nocturne)**<br><sub>NIGHT, SCENE & NOSTALGIA</sub> | A cool moonlit nocturne — a cratered moon over a still sea with a shimmering moonpath, drifting clouds, thin elegant serif, moon-phase ornaments. |
| <a href="#aurora"><img src="docs/themes/aurora.webp" width="150" alt="Aurora"></a> | **[Aurora](#aurora)**<br><sub>NIGHT, SCENE & NOSTALGIA</sub> | An arctic night under northern-lights curtains reflected on snow, pine-and-mountain silhouettes, a crisp starfield, aurora-gradient title fill. |
| <a href="#the-abyss"><img src="docs/themes/abyss.webp" width="150" alt="The Abyss"></a> | **[The Abyss](#the-abyss)**<br><sub>NIGHT, SCENE & NOSTALGIA</sub> | A submarine descent into crushing dark: fading god-rays, drifting bioluminescent plankton, an anglerfish with a glowing lure, a depth-gauge HUD, a `LEVIATHAN SIGHTED` finale. |
| <a href="#close-encounter"><img src="docs/themes/ufo.webp" width="150" alt="Close Encounter"></a> | **[Close Encounter](#close-encounter)**<br><sub>NIGHT, SCENE & NOSTALGIA</sub> | A 1950s drive-in flying saucer over a desert night — a chrome saucer with porthole lights, a green abduction beam, and a cow that gets taken every 18 seconds. |
...
| <a href="#blue-plate-diner"><img src="docs/themes/diner.webp" width="150" alt="Blue Plate Diner"></a> | **[Blue Plate Diner](#blue-plate-diner)**<br><sub>NIGHT, SCENE & NOSTALGIA</sub> | The credits as a 50s diner menu: chrome and red vinyl, an `OPEN 24H` neon sign, menu rows with dot-leaders to prices (bits as cents!), pie-and-coffee illustrations. |
| <a href="#end-of-broadcast"><img src="docs/themes/signoff.webp" width="150" alt="End of Broadcast"></a> | **[End of Broadcast](#end-of-broadcast)**<br><sub>NIGHT, SCENE & NOSTALGIA</sub> | The nostalgic TV sign-off: SMPTE color bars, an off-air test-pattern circle, a station ID, a `PLEASE STAND BY` slate fading to `END OF TRANSMISSION`. |
| <a href="#corkboard"><img src="docs/themes/scrapbook.webp" width="150" alt="Corkboard"></a> | **[Corkboard](#corkboard)**<br><sub>NIGHT, SCENE & NOSTALGIA</sub> | A polaroid scrapbook: each credit block is a taped-and-pinned photo card on cork, handwritten marker titles, heart-count amounts, string connecting the cards, a gold-star finale. |
| <a href="#the-crew"><img src="docs/themes/heist.webp" width="150" alt="The Crew"></a> | **[The Crew](#the-crew)**<br><sub>NIGHT, SCENE & NOSTALGIA</sub> | The end-credits as a heist crew reveal: a navy blueprint, a brushed-steel vault door, red laser tripwires, roles as section eyebrows, cuts of the take as amounts, a `THE SCORE` finale. |
...
The space-opera homage — golden text receding up a tilted plane into a deep starfield toward a glowing galactic core. The only theme that changes the physics of the crawl.
...
An engraved theatre programme on aged, gold-stamped cream stock — the one light theme. Cast-list rows with dotted leaders, small-caps headers, a warm limelight wash.
*Palette: cream paper + crimson + gilt · Playfair / EB Garamond · dot-leader cast list.*
...
A candlelit tavern ledger on night-stained parchment — blackletter quest headings, ruled sign-in rows with "× N" tallies, a wax-seal outro.
...
OutRun at 2AM: chrome VHS-logo titles over a magenta grid driving toward a striped sunset, a high-score-style roster, neon-tube outro.
*Palette: indigo night + magenta/cyan neon + gold sun · Audiowide/Orbitron · driving grid + sun.*
...
A CRT cabinet in attract mode: Press Start 2P pixel font, ranked HIGH SCORES panels with dot leaders and `PTS`, per-section hue cycling, a blinking `GAME OVER` outro.
...
Acid-green pirate-radio signal: oscilloscope waveform dividers under stencil titles, a `174 BPM / SIGNAL LOCKED` HUD, a breathing spectrum analyzer, `>> ON AIR` chip.
...
A 90s stoop jam: a detailed boombox, spray-paint graffiti titles on torn-paper labels, brick wall with string lights, cassette-tape dividers, `SOUND CLASH` finale.
*Palette: kraft + marker black/red/gold · spray-paint display · boombox hero.*
...
The credits as a festival poster: an LED-wall stage, volumetric laser fans, a phone-lit crowd silhouette, confetti, stage-name sections, a headliner finale.
...
A 6am hillside set — a soft rising sun with god-rays over a dawn-warmed sky, a crowd with raised hands watching, drifting lantern orbs, airy lowercase type. The calm one.
...
Arcade fighting-game energy: two rim-lit fighter silhouettes, ink brush-slash accents, roster rows with health bars, `ROUND N / FIGHT!` sections and a `K.O.!!` finale.
...
A classic 16-bit JRPG menu: beveled blue window-skin panels with double borders, a hand cursor on rows, `EXP +500` amounts, quest-complete banners, a `LEVEL UP!` finale.
...
An esports broadcast overlay: glossy angular lower-thirds, a floodlit arena crowd, hex accents, a scoreline, team-tag rows and an `MVP` finale.
...
A night-race world feed: a timing tower (position, name, gap), a floodlit grandstand crowd, an F1 car streaking the pit straight, a chequered-flag band, `CHEQUERED FLAG — P1` finale.
...
A holographic AR HUD over a neon city: glassmorphic panels, angular corner brackets, teal/magenta duotone, monospace stat chips, an `INTRUSION DETECTED` finale.
...
Rain-slick monochrome with venetian-blind light and film grain, typewriter case-file rows — and exactly one red word, saved for the raid finale.
*Palette: black + silver + one red · Special Elite / Courier Prime · blinds + grain.*
...
A cool moonlit nocturne — a cratered moon over a still sea with a shimmering moonpath, drifting clouds, thin elegant serif, moon-phase ornaments. Near-stillness.
*Palette: ink navy + moon silver · Cormorant Garamond · cratered moon + moonpath.*
...
An arctic night under northern-lights curtains reflected on snow, pine-and-mountain silhouettes, a crisp starfield, aurora-gradient title fill.
*Palette: ice green/violet/blue · thin sans · aurora curtains.*
...
A submarine descent into crushing dark: fading god-rays, drifting bioluminescent plankton, an anglerfish with a glowing lure, a depth-gauge HUD, a `LEVIATHAN SIGHTED` finale.
*Palette: near-black blue + cyan glow · cool sans · sonar + anglerfish.*
...
A 1950s drive-in flying saucer over a desert night — a chrome saucer with porthole lights, a green abduction beam, and a cow that gets taken every 18 seconds.
...
The credits as a 50s diner menu: chrome and red vinyl, an `OPEN 24H` neon sign, menu rows with dot-leaders to prices (bits as cents!), pie-and-coffee illustrations.
...
The nostalgic TV sign-off: SMPTE color bars, an off-air test-pattern circle, a station ID, a `PLEASE STAND BY` slate fading to `END OF TRANSMISSION`.
*Palette: broadcast bars + phosphor · caption sans · test card.*
...
A polaroid scrapbook: each credit block is a taped-and-pinned photo card on cork, handwritten marker titles, heart-count amounts, string connecting the cards, a gold-star finale.
*Palette: warm cork + polaroid white · Caveat / Kalam · pinned photo cards.*
...
The end-credits as a heist crew reveal: a navy blueprint, a brushed-steel vault door, red laser tripwires, roles as section eyebrows, cuts of the take as amounts, a `THE SCORE` finale.
