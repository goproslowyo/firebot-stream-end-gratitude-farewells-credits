...
head meta:last-of-type::after {
  ...
  transform: translateZ(0);
  opacity: 0.92;
  background: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 260 84'><defs><linearGradient id='gcard' x1='0' y1='0' x2='0' y2='1'><stop offset='0' stop-color='%230a2e38' stop-opacity='.62'/><stop offset='.5' stop-color='%2305191f' stop-opacity='.55'/><stop offset='1' stop-color='%23030f14' stop-opacity='.6'/></linearGradient></defs><rect x='1' y='1' width='258' height='82' rx='2' fill='url(%23gcard)' stroke='%232de2e6' stroke-opacity='.32' stroke-width='1.4'/><rect x='2.4' y='2.4' width='255.2' height='2' fill='%239ff3f5' fill-opacity='.14'/><g fill='none' stroke='%239ff3f5' stroke-opacity='.85' stroke-width='2'><path d='M2 12 L2 2 L12 2'/><path d='M258 12 L258 2 L248 2'/><path d='M2 72 L2 82 L12 82'/><path d='M258 72 L258 82 L248 82'/></g><circle cx='244' cy='14' r='2.4' fill='%232de2e6'/><circle cx='244' cy='14' r='4.5' fill='%232de2e6' fill-opacity='.25'/><text x='14' y='24' font-family='Courier New,monospace' font-size='12.5' letter-spacing='1' fill='%239ff3f5' fill-opacity='.95'>GRID 7497 // SECTOR K-9</text><line x1='14' y1='30' x2='232' y2='30' stroke='%232de2e6' stroke-opacity='.2' stroke-width='1'/><text x='14' y='46' font-family='Courier New,monospace' font-size='11' letter-spacing='1' fill='%232de2e6' fill-opacity='.6'>LAT 35.6595  LON 139.7005</text><rect x='14' y='56' width='170' height='11' fill='none' stroke='%23ff3864' stroke-opacity='.5' stroke-width='1'/><g fill='%23ff3864' fill-opacity='.8'><rect x='16' y='58' width='6' height='7'/><rect x='24' y='58' width='6' height='7'/><rect x='32' y='58' width='6' height='7'/></g><g fill='%23ff3864' fill-opacity='.12'><rect x='40' y='58' width='6' height='7'/><rect x='48' y='58' width='6' height='7'/><rect x='56' y='58' width='6' height='7'/><rect x='64' y='58' width='6' height='7'/><rect x='72' y='58' width='6' height='7'/><rect x='80' y='58' width='6' height='7'/><rect x='88' y='58' width='6' height='7'/><rect x='96' y='58' width='6' height='7'/><rect x='104' y='58' width='6' height='7'/><rect x='112' y='58' width='6' height='7'/><rect x='120' y='58' width='6' height='7'/><rect x='128' y='58' width='6' height='7'/><rect x='136' y='58' width='6' height='7'/><rect x='144' y='58' width='6' height='7'/><rect x='152' y='58' width='6' height='7'/><rect x='160' y='58' width='6' height='7'/><rect x='168' y='58' width='6' height='7'/><rect x='176' y='58' width='6' height='7'/></g><text x='194' y='65' font-family='Courier New,monospace' font-size='11' fill='%23ff8fa8' fill-opacity='.85'>TRACE 12%25</text></svg>") center / contain no-repeat;
}
...
.credits-slide:not(.flourish) .credits-block__list {
  ...
  background:
    ...
    linear-gradient(122deg, rgba(240,254,255,0) 7%, rgba(240,254,255,0.34) 12%, rgba(240,254,255,0.08) 15.5%, rgba(240,254,255,0) 20%),
    linear-gradient(122deg, rgba(224,251,252,0) 22%, rgba(224,251,252,0.1) 26%, rgba(224,251,252,0) 31%),
    /* diagonal frosted sheen — a soft glass highlight raking the top-left */
    linear-gradient(128deg, rgba(159,243,245,0.16) 0%, rgba(159,243,245,0.05) 18%, rgba(159,243,245,0) 36%),
